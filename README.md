...
TDZ(temporal dead zone): მოკელდ ეს არის ის ადგილი სადაც რომელიღაც ცვლადის გამოყენება არ შეგვიძლია, TDZ გვეხმარება ერორების უფრო მარტივად აღმოჩენაში და ის const ცვლადს რეაულრად ამუშავებს.
